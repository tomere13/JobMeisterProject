...
describe('Login module', () => {
  beforeEach(() => {
    jest.resetModules();
    document.body.innerHTML = '<div id="navbarCollapse"></div> <p></p> <div class="navbar"></div> <h3></h3> <p></p> <div class="nav-item"></div> <h1></h1> <h4></h4> <h5></h5> <h2></h2> <div class="row"></div> <div class="bgf"></div> <div class="bgdark"></div> <div id="divDark"></div>  <body></body> <button id="darkBtn"></button> <a class="loginbtn"></a> <button id="largeFont"></button> <div class="navG"></div>';
    require('./login.js')
  });
...
test('Login dark mode test', () => {
  ...
  test('Index large text test', () => {
    ...
    expect($("h2")[0].classList.contains("largerH2")).toBe(true);
    ...
    expect($("h2")[0].classList.contains("largerH2")).toBe(false);
